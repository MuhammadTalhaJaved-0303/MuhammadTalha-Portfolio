        ...
        <div className="relative grid lg:grid-cols-[1fr_2fr] gap-10">
          ...
          <div className="hidden lg:block">
            ...
            <p className="text-[var(--color-text-2)] text-sm leading-relaxed">
              Shipping production EdTech platforms as an AI engineer, alongside
              industry experience in ML pipelines, EDA, and model evaluation.
            </p>
          </div>
            ...
            {experience.map((e, i) => (
              ...
              >
                <span className="absolute -left-[37px] top-2 flex h-3 w-3 items-center justify-center">
                  <span className="absolute inset-0 rounded-full bg-[var(--color-gold)] opacity-40 animate-ping" />
                  <span className="relative h-3 w-3 rounded-full bg-[var(--color-gold)] shadow-[0_0_18px_var(--color-gold)]" />
                </span>
                <div className="rounded-2xl border border-[var(--color-border-soft)] bg-[var(--color-bg-elev)]/60 backdrop-blur p-6 hover:border-[var(--color-border-bright)] hover:shadow-[var(--shadow-glow-gold)] transition">
